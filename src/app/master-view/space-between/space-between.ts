...
export default class SpaceBetween extends LitElement {
  ...
  @query('#button-2')
  public button2?: IgcButtonComponent;

  @query('#dropdown-2')
  public dropdown2?: IgcDropdownComponent;
    ...
    return html`
      ...
      <div class="column-layout group">
        <div class="row-layout group_1">
          ...
          <igc-button variant="flat" @click=${() => this.dropdown2?.toggle(this.button2)} id="button-2" class="button">
          ...
          <igc-dropdown id="dropdown-2" class="dropdown">
            <igc-dropdown-item>
              Option
            </igc-dropdown-item>
            <igc-dropdown-item>
